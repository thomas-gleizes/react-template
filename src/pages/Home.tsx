      ...
      <div className="relative bg-yellow-50 w-full h-full rounded-lg border border-yellow-100 shadow-xl">
        <div className="absolute top-1/3 -mt-10 w-full">
          ...
          <div className="text-center font-light text-md">
            ...
            <ol>
              <li>
                <a className="hover:underline" href="https://fr.reactjs.org/" target="_blank">
                  React
                </a>
              </li>
              <li>
                <a className="hover:underline" href="https://tailwindcss.com/" target="_blank">
                  Tailwindcss
                </a>
              </li>
              <li>
                <a className="hover:underline" href="https://prettier.io/" target="_blank">
                  Prettier
                </a>
              </li>
              <li>
                <a className="hover:underline" href="https://www.typescriptlang.org/" target="_blank">
                  Typescript
                </a>
              </li>
            </ol>
